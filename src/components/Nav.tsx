...
export default function Nav() {
  ...
  const width = useTransform(scrollY, [0, 400], [720, 600]);
  ...
  return (
    ...
    >
      <motion.nav
        style={{ width, opacity }}
        className={`glass-nav relative flex items-center justify-between rounded-full px-3 py-2 transition-all duration-500 md:px-4 ${
          scrolled
      ...
      >
        ...
        <a
          href="#top"
          data-cursor="hover"
          className="flex items-center gap-2 px-2 py-1.5 md:px-3"
        >
        ...
        <a
          href="#contact"
          data-cursor="hover"
          className="group flex items-center gap-1.5 rounded-full bg-white px-3 py-1.5 text-[11px] font-medium text-black transition-all duration-300 hover:bg-[#D2D2D7] md:px-4"
        >
